...
\time{1/4}: Time signature
\key{1=C}: Key signature
\tempo{100}: Tempo

1^{.}, 1^{..}, etc.: Raised octave
1_{.}, 1_{..}, etc.: Lowered octave
...
\slur{1, 2, 3, 4}: Slur. In the example, the slur starts at 1 and ends at 4.

\p{1}: Piano associated with note 1.
\mp{1}: Mezzo-piano ____''____
\f{1}: Forte ____''____
\mf{1}: Mezzo-forte ____''____
\cresc{1, 2, 3, 4}: Crescendo
\dim{4, 3, 2, 1}: Diminuendo/Decrescendo, didn't differentiate between the two :)
